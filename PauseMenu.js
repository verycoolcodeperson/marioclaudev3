...
// ---------------------------------------------------------------------------
import { showControlsPanel } from './ControlsPanel.js';
  ...
  constructor(container, { onResume, onRestart, onQuit }) {
    ...
    this.el.innerHTML = `
      <div class="pause-card">
        ...
        <button class="pause-btn secondary" data-a="controls">Controls</button>
    ...
    this.el.querySelector('[data-a="controls"]').onclick = () => showControlsPanel(container);
