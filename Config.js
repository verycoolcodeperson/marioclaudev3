...
export const PHYSICS = {
  ...
  groundPoundSpeed: -22,
  groundPoundSpinTime: 0.24, // SM64-style hang + spin before the slam drops
  punchTime: 0.3,
  friction: 10,
  acceleration: 40,
  crouchSpeedMul: 0.45,
...
export const CAMERA = {
  ...
  verticalDeadzone: 2.2,     // how far the player may drift vertically before the camera hurries
  verticalCatchupRange: 5,   // over this much further, the lerp ramps to heightCatchupLerp
  heightCatchupLerp: 7,      // fast enough to keep a long fall on screen
  heightPerOffset: 0.62,     // extra camera height gained per unit of extra standoff
  minDistance: 4,
