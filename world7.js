...
function level7_1() {
  ...
  b.gap(2.2);
  b.plateau({ rise: 2.4, topLength: 7, width: 6, steps: 3, textureType: 'speckle', color: 0xfff6dd });
  b.scatterProps(['bush'], 3);
  b.enemyHere('paragoomba', { offsetX: -4.5, range: 2 });
  b.enemyHere('lakitu', { offsetX: -1.5, range: 2.2 });
  b.coinRow(4, { offsetX: -5, spacing: 0.9, height: 1.3 });
  b.luckyBlockHere({ offsetX: -3, contents: 'fire' });
  b.checkpointHere({ offsetX: -0.5 });

  b.gap(2.4);
  b.pillars(3, { width: 3, topLength: 1.8, gapWidth: 1.8, textureType: 'speckle', color: 0xfff6dd });
  ...
  b.enemyHere('koopa', { offsetX: -1, range: 1.6 });
...
function level7_2() {
  ...
  b.gap(2.4);
  b.zigzag(4, { stepLength: 2.4, width: 3.4, gapWidth: 1.3, offsetZ: 2.1, textureType: 'speckle', color: 0xfff6dd });
  b.coinRow(4, { offsetX: -6, spacing: 1.6, height: 1.4 });

  b.gap(1.8);
  b.ground(7, { width: 6, textureType: 'speckle', color: 0xfff6dd});
  b.scatterProps(['bush'], 3);
  b.enemyHere('lakitu', { offsetX: -5, range: 2.4 });
  b.enemyHere('paragoomba', { offsetX: -2, range: 1.8 });
  b.powerupHere('fire', { offsetX: -6 });
  b.checkpointHere({ offsetX: -0.5 });

  b.gap(2.2);
  b.valley({ depth: 2.2, floorLength: 5, width: 5, steps: 2, textureType: 'speckle', color: 0xfff6dd });
  b.coinRow(3, { offsetX: -4, spacing: 0.9, height: 1.3 });
  b.enemyHere('koopa', { offsetX: -2, range: 1.6 });
...
function level7_3() {
  ...
  b.ground(7, { width: 6, textureType: 'speckle', color: 0xfff6dd});
  b.scatterProps(['bush'], 3);
  b.enemyHere('paragoomba', { offsetX: -5, range: 2.2 });
  b.enemyHere('lakitu', { offsetX: -2, range: 2 });
  ...
  b.gap(8);
  b.ground(5, { width: 5, textureType: 'speckle', color: 0xfff6dd});
  b.coinRow(3, { offsetX: -3.5, spacing: 1, height: 1.4, arc: true });
  b.enemyHere('koopa', { offsetX: -1.5, range: 1.6 });

  b.gap(2.2);
  b.plateau({ rise: 1.8, topLength: 6, width: 6, steps: 2, textureType: 'speckle', color: 0xfff6dd });
