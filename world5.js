...
function level5_1() {
  ...
  b.gap(2.2);
  b.plateau({ rise: 2.4, topLength: 7, width: 6, steps: 3, textureType: 'speckle', color: 0xe8d6a0 });
  b.scatterProps(['rock','bush'], 3);
  b.enemyHere('cheep', { offsetX: -4.5, range: 2 });
  ...
  b.gap(2.4);
  b.pillars(3, { width: 3, topLength: 1.8, gapWidth: 1.8, textureType: 'speckle', color: 0xe8d6a0 });
...
function level5_2() {
  ...
  b.gap(2.4);
  b.zigzag(4, { stepLength: 2.4, width: 3.4, gapWidth: 1.3, offsetZ: 2.1, textureType: 'speckle', color: 0xe8d6a0 });
  b.coinRow(4, { offsetX: -6, spacing: 1.6, height: 1.4 });

  b.gap(1.8);
  b.ground(7, { width: 6, textureType: 'speckle', color: 0xe8d6a0});
  b.scatterProps(['rock','bush'], 3);
  b.enemyHere('koopa', { offsetX: -5, range: 2.4 });
  b.enemyHere('cheep', { offsetX: -2, range: 1.8 });
  b.powerupHere('fire', { offsetX: -6 });
  b.checkpointHere({ offsetX: -0.5 });

  b.gap(2.2);
  b.valley({ depth: 2.2, floorLength: 5, width: 5, steps: 2, textureType: 'speckle', color: 0xe8d6a0 });
...
function level5_3() {
  ...
  b.ground(7, { width: 6, textureType: 'speckle', color: 0xe8d6a0});
  b.scatterProps(['rock','bush'], 3);
  b.enemyHere('cheep', { offsetX: -5, range: 2.2 });
  ...
  b.gap(8);
  b.ground(5, { width: 5, textureType: 'speckle', color: 0xe8d6a0});
  b.coinRow(3, { offsetX: -3.5, spacing: 1, height: 1.4, arc: true });
  b.enemyHere('spiny', { offsetX: -1.5, range: 1.6 });

  b.gap(2.2);
  b.plateau({ rise: 1.8, topLength: 6, width: 6, steps: 2, textureType: 'speckle', color: 0xe8d6a0 });
