...
function level1_1() {
  ...
  b.gap(2.2);
  b.plateau({ rise: 2.4, topLength: 7, width: 6, steps: 3 });
  b.scatterProps(['tree','bush','flower'], 3);
  ...
  b.gap(2.4);
  b.pillars(3, { width: 3, topLength: 1.8, gapWidth: 1.8 });
  ...
  b.enemyHere('buzzy', { offsetX: -1, range: 1.6 });
...
function level1_2() {
  ...
  b.gap(2.4);
  b.zigzag(4, { stepLength: 2.4, width: 3.4, gapWidth: 1.3, offsetZ: 2.1 });
  ...
  b.gap(2.2);
  b.valley({ depth: 2.2, floorLength: 5, width: 5, steps: 2 });
...
function level1_3() {
  ...
  b.enemyHere('buzzy', { offsetX: -1.5, range: 1.6 });

  b.gap(2.2);
  b.plateau({ rise: 1.8, topLength: 6, width: 6, steps: 2 });
