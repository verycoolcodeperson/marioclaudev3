...
export function buildTutorialLevel() {
  ...
  b.gap(2.2);
  b.ground(7, { width: 6 });
  b.hintSignHere('Grab the Fire Flower - now ACTION on the ground throws fireballs!', { offsetX: -6, offsetZ: 1.8 });
  b.powerupHere('fire', { offsetX: -4.5 });
  b.enemyHere('goomba', { offsetX: -1.5, range: 1.4 });
  b.coinRow(3, { offsetX: -4, spacing: 0.9, height: 1.2 });

  b.gap(2);
  b.ground(8, { width: 6 });
  b.hintSignHere('A Mega Mushroom makes you huge - jump into those bricks to smash them!', { offsetX: -7, offsetZ: 1.8 });
  b.powerupHere('mega', { offsetX: -5.5 });
  b.brickRow(4, { offsetX: -3.5, height: 2.5 });
  b.coinRow(3, { offsetX: -3.5, spacing: 1, height: 4.2 });
