...
class SFXManager {
  ...
  play(name) {
    switch (name) {
      ...
      case 'powerup': this._tone(523, 0.09, { gain: 0.2 }); this._tone(659, 0.09, { gain: 0.2, delay: 0.08 }); this._tone(880, 0.09, { gain: 0.2, delay: 0.16 }); this._tone(1174, 0.22, { gain: 0.22, delay: 0.24 }); break;
      case 'fireball': this._tone(760, 0.12, { type: 'sawtooth', slideTo: 320, gain: 0.16 }); break;
      case 'breakBlock': this._tone(200, 0.16, { type: 'square', slideTo: 70, gain: 0.24 }); this._tone(420, 0.1, { type: 'square', slideTo: 140, gain: 0.16, delay: 0.03 }); break;
